...
const PROFILE = {
  ...
  avatar: "/xniu.jpg",
  researchSummary:
    "My research interests lie at the intersection of operations research, machine learning, and network science. I advance theoretical understanding and develop efficient methods for learning and decision-making in large-scale stochastic and networked systems. My recent work has explored sparse network design, community detection and matching in random geometric graphs, and multi-agent and multi-source learning, with applications in business, engineering, and the natural sciences.",
} as const;
